...
@Service
public class MicroProjectNotifService {
    
    
    Logger logger = LoggerFactory.getLogger(MicroProjectNotifService.class);
    ...
    public MicroProjectNotifService(MailService mailService, 
