...
public class NotifTriggerDTO {
    ...
    public NotifTriggerDTO(){}

    public NotifTriggerDTO(List<NotifEntity> entities, Long senderId, String senderLogin, NotifAction action,
