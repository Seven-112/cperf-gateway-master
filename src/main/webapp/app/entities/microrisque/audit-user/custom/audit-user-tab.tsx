...
interface IAuditUserTabTabProps{
    audit: IAudit,
...
export const AuditUserTab = (props: IAuditUserTabTabProps) =>{
   ...
   return (
       <React.Fragment>
           {openUserSelectorModal && props.audit && props.role && 
            <UserExtraFinder2 
