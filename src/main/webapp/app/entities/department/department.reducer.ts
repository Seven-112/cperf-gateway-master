...
export const ACTION_TYPES = {
  ...
  FETCH_DEPARTMENT_ALL: 'department/FETCH_DEPARTMENT_ALL',
...
export default (state: DepartmentState = initialState, action): DepartmentState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.FETCH_DEPARTMENT_ALL):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.FETCH_DEPARTMENT_ALL):
    ...
    case SUCCESS(ACTION_TYPES.FETCH_DEPARTMENT_ALL):
      return {
        ...state,
        loading: false,
        entities: action.payload.data,
...
export const getAllEntities: ICrudGetAllAction<IDepartment> = () => {
  const requestUrl = `${apiUrl}/all`;
  return {
    type: ACTION_TYPES.FETCH_DEPARTMENT_ALL,
