...
export const DepartmentDetail = (props: IDepartmentDetailProps) => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2>
          <Translate contentKey="microgatewayApp.department.detail.title">Department</Translate> [<b>{departmentEntity.id}</b>]
        </h2>
        <dl className="jh-entity-details">
          <dt>
            <span id="name">
              <Translate contentKey="microgatewayApp.department.name">Name</Translate>
            </span>
          </dt>
