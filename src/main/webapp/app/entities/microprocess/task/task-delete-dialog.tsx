...
export const TaskDeleteDialog = (props: ITaskDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="microgatewayApp.microprocessTask.delete.question">
        <Translate contentKey="microgatewayApp.microprocessTask.delete.question" interpolate={{ id: taskEntity.id }}>
