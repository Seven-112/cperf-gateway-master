...
export const ProcessDeleteDialog = (props: IProcessDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="microgatewayApp.microprocessProcess.delete.question">
        <Translate contentKey="microgatewayApp.microprocessProcess.delete.question" interpolate={{ id: processEntity.id }}>
