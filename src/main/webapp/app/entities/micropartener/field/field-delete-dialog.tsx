...
export const FieldDeleteDialog = (props: IFieldDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="microgatewayApp.micropartenerField.delete.question">
        <Translate contentKey="microgatewayApp.micropartenerField.delete.question" interpolate={{ id: fieldEntity.id }}>
