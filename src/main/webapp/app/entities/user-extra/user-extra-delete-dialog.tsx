...
export const UserExtraDeleteDialog = (props: IUserExtraDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="microgatewayApp.userExtra.delete.question">
        <Translate contentKey="microgatewayApp.userExtra.delete.question" interpolate={{ id: userExtraEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-userExtra" color="danger" onClick={confirmDelete}>
