...
export const UserExtra = (props: IUserExtraProps) => {
  ...
  const { userExtraList, match, loading, totalItems } = props;
  return (
    <div>
      <h2 id="user-extra-heading">
        <Translate contentKey="microgatewayApp.userExtra.home.title">User Extras</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="microgatewayApp.userExtra.home.createLabel">Create new User Extra</Translate>
        </Link>
      </h2>
        ...
        {userExtraList && userExtraList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('photoId')}>
                  <Translate contentKey="microgatewayApp.userExtra.photoId">Photo Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="microgatewayApp.userExtra.user">User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="microgatewayApp.userExtra.employee">Employee</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {userExtraList.map((userExtra, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{userExtra.photoId}</td>
                  <td>{userExtra.user ? userExtra.user.login : ''}</td>
                  <td>{userExtra.employee ? <Link to={`employee/${userExtra.employee.id}`}>{userExtra.employee.id}</Link> : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="microgatewayApp.userExtra.home.notFound">No User Extras found</Translate>
            </div>
          )
        )}
      </div>
