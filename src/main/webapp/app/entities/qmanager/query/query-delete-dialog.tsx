...
export const QueryDeleteDialog = (props: IQueryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="microgatewayApp.qmanagerQuery.delete.question">
        <Translate contentKey="microgatewayApp.qmanagerQuery.delete.question" interpolate={{ id: queryEntity.id }}>
