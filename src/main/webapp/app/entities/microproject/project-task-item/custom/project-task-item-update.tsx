...
export const ProjectTaskItemUpdate = (props: TaskItemUpdateProps) =>{
    const { open } = props;
    const [taskItem, settaskItem] = useState<IProjectTaskItem>(props.taskItem);
    ...
    const handleSubmit = (event) =>{
        ...
        if(taskItem && taskItem.checkerId && taskItem.name && taskItem.checkerName){
            setLoading(true);
            const req = isNew ? axios.post<IProjectTaskItem>(API_URIS.projectTaskItemApiUri, cleanEntity(taskItem))
                                : axios.put<IProjectTaskItem>(API_URIS.projectTaskItemApiUri, cleanEntity(taskItem));
            req.then(res =>{
                if(res.data){
...
export default ProjectTaskItemUpdate;
