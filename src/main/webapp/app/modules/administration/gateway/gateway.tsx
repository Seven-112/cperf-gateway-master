    ...
    return (
      <div>
        ...
        <Table striped responsive>
          ...
          <tbody>
            {routes.map((route, i) => (
              <tr key={`routes-${i}`} className="bg-info">
                <td className="bg-info text-white">{route.path}</td>
                <td className="bg-info text-white">{route.serviceId}</td>
                <td  className="bg-info text-white">{this.instanceInfo(route)}</td>
              </tr>
            ))}
          </tbody>
        </Table>
