    ...
    <table className="table table-sm table-striped table-bordered">
      ...
      <tbody>
        {activities.map((activity, i) => (
          <tr key={`log-row-${i}`}>
            <td className="text-primary">{activity.userLogin}</td>
            <td className="text-primary">{activity.ipAddress}</td>
            <td className="text-primary">{activity.page}</td>
            <td className="text-primary">{activity.time}</td>
          </tr>
        ))}
      </tbody>
    </table>
