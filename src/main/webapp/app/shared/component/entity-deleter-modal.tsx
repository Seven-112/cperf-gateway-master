...
interface EntityDeleterModalProps{
    entityId:number,
    urlWithoutEntityId:string,
    open?:boolean,
    question?:any,
    onDelete:Function,
    onClose:Function,
...
export const EntityDeleterModal = (props: EntityDeleterModalProps) =>{
    const {entityId, urlWithoutEntityId, open, question} = props;
    ...
    const handleDelete = () =>{
        setLoading(true);
        setError(false);
        axios.delete(`${urlWithoutEntityId}/${entityId}`)
            .then(() =>props.onDelete(entityId))
            .catch(e =>{
                console.log(e);
                setError(true);
...
export default EntityDeleterModal;